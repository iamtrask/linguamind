...
class Vector(_object):
    ...
    def __init__(self, x, y, z):
        this = _example.new_Vector(x, y, z)
        try:
    ...
    def cprint(self):
        return _example.Vector_cprint(self)
Vector_swigregister = _example.Vector_swigregister
Vector_swigregister(Vector)


def addv(a, b):
    return _example.addv(a, b)
addv = _example.addv
class VectorArray(_object):
    ...
    def __init__(self, maxsize):
        this = _example.new_VectorArray(maxsize)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def size(self):
        return _example.VectorArray_size(self)

    def get(self, index):
        return _example.VectorArray_get(self, index)

    def set(self, index, a):
        return _example.VectorArray_set(self, index, a)
